...
const AchievementCard = ({ value, description }) => (
  <div className="flex flex-col justify-center items-center bg-gradient-to-r from-[#F28767] to-[#FDB079] p-6 md:p-8 h-[156px] w-[156px] md:w-[240px] md:h-[240px] rounded-full justify-self-center overflow-hidden transition-transform transform hover:scale-105 ease-in-out duration-300 shadow-lg">
