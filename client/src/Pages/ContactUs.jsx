            ...
            <div className="-m-2 flex flex-wrap">
              ...
              <div className="w-1/2 p-2">
                <div className="relative">
                  ...
                  <label
                    htmlFor="name"
                    className="absolute left-3 -top-6 bg-transparent text-sm leading-7 text-gray-300 transition-all peer-placeholder-shown:left-3 peer-placeholder-shown:top-2  peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:left-3 peer-focus:-top-6 peer-focus:text-sm "
                  >
                    Name
                  </label>
                </div>
              ...
              {/* footer */}
              <div className="mt-8 w-full border-t border-gray-600 p-2 pt-8 text-center">
