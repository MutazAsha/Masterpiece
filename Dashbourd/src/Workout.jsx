...
//       <table className="w-full sm:w-11/12 md:w-5/6 lg:w-3/4 xl:w-2/3 bg-white border border-gray-300">
...
const WorkoutPage = () => {
  ...
  const handleSave = (exerciseData) => {
    axios
      .put(`http://localhost:8080/updateExerciseImage/${exerciseData.id}`, exerciseData)
      .then((response) => {
        console.log('Exercise data updated successfully:', response.data);
